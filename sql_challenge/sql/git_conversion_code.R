...
write.csv(cont_map_df,'~/Documents/Job Search/Salesloft/Data Analyst/Assessment/continent_map.csv',row.names = FALSE)
write.csv(conts_df,'~/Documents/Job Search/Salesloft/Data Analyst/Assessment/continents.csv',row.names = FALSE)
write.csv(countries_df,'~/Documents/Job Search/Salesloft/Data Analyst/Assessment/countries.csv',row.names = FALSE)
write.csv(per_cap_df,'~/Documents/Job Search/Salesloft/Data Analyst/Assessment/per_capita.csv',row.names = FALSE)
